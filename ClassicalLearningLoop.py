...
names = ["RAW_classic_split_",
         "Fourier_classic_split_",
         "Chebyshev_7_classic_split_",
         "Legendre_7_classic_split_",
         "Hermite_E_7_classic_split_"]
...
for exp_name, ort in zip(names, orts):
